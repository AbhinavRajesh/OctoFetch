  ...
  render() {
    return (
      <div className={styles.container}>
        ...
        <a href="https://github.com/AbhinavRajesh/OctoFetch" target="_blank" rel="noopener noreferrer">
        ...
        <footer>
          ...
          <div className={styles.bottom}>
            <a href="https://github.com/AbhinavRajesh">GitHub</a>
            <a href="https://www.instagram.com/pv._abhinav_/">Instagram</a>
            <a href="https://twitter.com/AbhinavRajesh9">Twitter</a>
          </div>
        </footer>
      </div>
    );
